...
Rico.Accordion.prototype = {
   ...
   setOptions: function(options) {
      this.options = {
         expandedBg          : '#63699c',
         expandedBgImage     : 'none',
         hoverBg             : '#63699c',
         hoverBgImage        : 'none',
         collapsedBg         : '#6b79a5',
         collapsedBgImage    : 'none',
...
Rico.Accordion.Tab.prototype = {
   ...
   showCollapsed: function() {
      ...
      this.titleBar.style.backgroundImage = this.accordion.options.collapsedBgImage;
   ...
   showExpanded: function() {
      ...
      this.titleBar.style.backgroundImage = this.accordion.options.expandedBgImage;
   ...
   hover: function(e) {
		...
		this.titleBar.style.backgroundImage = this.accordion.options.hoverBgImage;
