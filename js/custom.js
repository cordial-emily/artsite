...
//Creates D3 time-of-year effect 
//Used on C.V.

function codeYear() {
var now = new Date(d3.time.year.floor(new Date()));

var spacetime = d3.select('article');
var width = 960,
    height = 500,
...
svg.append("circle")
  .attr("class", "sun")
  .attr("r", radii.sun)
  .style("fill", "rgba(253, 246, 165, 1.0)");
...
svg.append("path")
  ...
  .style("fill", "rgba(253, 246, 165, 0.75)");
...
svg.append("path")
  ...
  .attr("d", day)
  .attr("transform", "translate(0," + -radii.earthOrbit + ")")
  .style("fill", "rgba(147, 244, 253, 1.0)");
